...
#ifndef LV_ATTRIBUTE_IMG_GIT_LOGO_60X140
#define LV_ATTRIBUTE_IMG_GIT_LOGO_60X140
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_GIT_LOGO_60X140 uint8_t 
    git_logo_60x140_map[] = {
#if CONFIG_NICE_VIEW_WIDGET_INVERTED
        0xff, 0xff, 0xff, 0xff, /*Color of index 0*/
        0x00, 0x00, 0x00, 0xff, /*Color of index 1*/
...
const lv_img_dsc_t git_logo_60x140 = {
  .header.cf = LV_IMG_CF_INDEXED_1BIT,
  .header.always_zero = 0,
  .header.reserved = 0,
  .header.w = 68,
